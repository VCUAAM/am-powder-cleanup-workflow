...
**VCU Additive Manufacturing — Automated Post-Processing Toolkit**
...
Both the am_vision and the robot_control READMEs have been updated, and the code in those scripts have also been commented. 
...
| Package | Description |
|----------|--------------|
| **am_vision** | Image and depth processing utilities for mask generation, thresholding, and orientation correction. *Note:* this package is currently in a **rough, pre-refactor state**—it contains working scripts from earlier project iterations and will be restructured in future updates. |
...
```
+-----------------+        +------------------+        +-------------------+        +----------------+
|  RGB-D Capture  | ----→  |    am_vision     | ----→  |     ml_vision      | ----→  |  path_planner  |
